...
export default function AuthenticationApi() {
  ...
  //         "title": `Change title  ${Date.now(ch)}`,
  //         "price": 100
  //       })
  ...
  const createUser = async () => {
    ...
    console.log(response.data.access_token,"datyaaaaaaaaaaa")
  ...
  const userVerify = async () => {
    ...
    const verifyToken = localStorage.getItem("access_key");

    console.log(verifyToken,"tokennnnnnnnnnnnnnnnnn")
    ...
    console.log(response.data,"user dataaaaaaaaaaaaaaaa")
  }
  ...
  return (
    <>
      ...
      <button onClick={createUser}>create user data</button>

      <button onClick={userVerify}>get user data</button>
